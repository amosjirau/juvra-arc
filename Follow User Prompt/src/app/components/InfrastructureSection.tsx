      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
          ...
          >
            <div className="relative">
              ...
              <div className="relative w-24 h-24 rounded-2xl bg-gradient-to-br from-[#FF7A18]/30 to-[#FF7A18]/10 border border-[#FF7A18]/30 flex items-center justify-center shadow-[0_0_48px_rgba(255,122,24,0.2)]">
                <span style={{ fontFamily: "Instrument Serif, serif" }} className="text-white text-2xl">J</span>
              </div>
            </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {partners.map((p, i) => (
              ...
              >
                ...
                <p style={{ fontFamily: "Instrument Serif, serif" }} className="text-white text-lg mb-1">{p.name}</p>
        ...
        >
          <p className="text-[#8892a4] text-sm">
            ...
            <a href="#" className="text-[#FF7A18] hover:underline">View contract registry →</a>
          </p>
        </motion.div>
      </div>
    </section>
