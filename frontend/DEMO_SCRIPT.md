...
## 2:10-2:35 - Recommendation And Manual Settlement

Run the recommendation engine. Show that the agent may recommend release, revision, or dispute review, but the client must click the settlement action and confirm through the wallet before escrow funds can move.
