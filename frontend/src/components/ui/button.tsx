  ...
  "group/button inline-flex shrink-0 items-center justify-center rounded-xl border border-transparent bg-clip-padding text-sm font-semibold whitespace-nowrap shadow-sm transition-all duration-200 outline-none select-none hover:-translate-y-0.5 active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:translate-y-0 disabled:opacity-45 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/40 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        ...
        outline: "border-line bg-paper-raised text-ink hover:bg-ink/[0.04] aria-expanded:bg-ink/[0.06]",
        secondary: "border-line bg-paper text-ink hover:bg-ink/[0.04]",
        ghost: "text-ink-soft hover:bg-ink/[0.05] hover:text-ink aria-expanded:bg-ink/[0.06] aria-expanded:text-ink",
        destructive:
          "border-rose-300/40 bg-rose-500/[0.06] text-rose-700 hover:bg-rose-500/10",
