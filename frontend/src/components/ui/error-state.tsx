...
export function ErrorState({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "relative overflow-hidden rounded-2xl border border-rose-300/40 bg-rose-500/[0.06] p-10 text-center shadow-2xl shadow-black/20 backdrop-blur-xl",
        className,
      )}
    >
      <div
      ...
      <motion.span
        ...
        className="relative mx-auto flex size-14 items-center justify-center rounded-2xl border border-rose-300/40 bg-rose-500/[0.06] text-rose-700 shadow-lg "
      >
